...
class FrameworkModel(nn.Module):
    ...
    def forward(self, datas):
        ...
        user_reviews, item_reviews, user_uids, item_ids, user_item2id, item_user2id, user_doc, item_doc = datas
        ...
        output = self.predict_net(ui_feature, user_uids, item_ids).squeeze(1)
        return output
